    ...
    Widget displayVerifiedUsersDesign() {
      if (allUsers != null) {
        return ListView.builder(
          ...
          itemCount: allUsers!.docs.length,
          itemBuilder: (context, i) {
            final photoUrl = allUsers!.docs[i].get("photoUrl") as String?;
            final name = allUsers!.docs[i].get("name") as String?;
            final email = allUsers!.docs[i].get("email") as String?;
                    ...
                    child: ListTile(
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          image: DecorationImage(
                            image: NetworkImage(photoUrl ?? 'fallback_image_url'),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
